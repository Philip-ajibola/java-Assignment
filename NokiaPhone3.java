...
public class NokiaPhone3{
	...
	case 13:
		...
		System.out.print("Would You like to go back to the home page and continue running the apps, if yes (press 1), if no (press 2) ");
	...
	case 13:
		...
		System.out.print("Would You like to go back to the home page and continue running the app, if yes (press 1), if no (press 2) ");
				 continuation = input.nextInt();
