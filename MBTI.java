...
public class MBTI{
	...
	private String name;
	private static String[] extrovertOrIntrovert = new String[5];
	private static String[] sensingOrIntuitive = new String[5];
	private static String[] thinkingOrFeeling = new String[5];
	private static String[] judgingOrPerceptive = new String[5];
	...
	public void displayQuestionAndResult(){
