...
public class SeperationOfIntergers2{
  ...
  System.out.println("Enter A Number from 0 to 10000");
   ...
   if (userInput>1000 ){
      System.out.printf(" %d  %d  %d  %d%n",forthDigit1,thirdDigit1,secondDigit1,firstDigit1);          
       ...
       if (userInput<1000){
      System.out.printf("  %d  %d  %d%n",thirdDigit2,secondDigit2,firstDigit2);          
       }

        if (userInput>10){
      System.out.printf(" %d  %d%n",secondDigit3,firstDigit3);          
       }

        if (userInput<10){
      System.out.printf(" %d%n",firstDigit4);          
      }
